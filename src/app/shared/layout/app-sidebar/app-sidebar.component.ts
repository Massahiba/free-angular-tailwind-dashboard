  ...
  navItems: NavItem[] = [
...

    {
      ...
      subItems: [
        ...
        { name: "Conducteurs", path: "/conducteurs" },
    ...
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M6.5 2C5.11929 2 4 3.11929 4 4.5V19.5C4 20.8807 5.11929 22 6.5 22H17.5C18.8807 22 20 20.8807 20 19.5V9H17C15.9 9 15 8.1 15 7V4H6.5C6.22386 4 6 4.22386 6 4.5V7H9C9.55228 7 10 7.44772 10 8C10 8.55228 9.55228 9 9 9H6V12H9C9.55228 12 10 12.4477 10 13C10 13.5523 9.55228 14 9 14H6V17H9C9.55228 17 10 17.4477 10 18C10 18.5523 9.55228 19 9 19H6V19.5C6 19.7761 6.22386 20 6.5 20H17.5C17.7761 20 18 19.7761 18 19.5V9.5H17C16.4477 9.5 16 9.05228 16 8.5V4.5C16 4.22386 15.7761 4 15.5 4H15V7C15 7.55228 14.5523 8 14 8H11V5H14V4H11C10.4477 4 10 4.44772 10 5V8H6.5C6.22386 8 6 7.77614 6 7.5V4H6.5Z" fill="currentColor"></path></svg>`,
      name: "Maintenance",
      subItems: [
        { name: "Vidanges", path: "/vidanges" },
        { name: "Visites Techniques", path: "/visites-techniques" },
        { name: "Pannes", path: "/pannes" },
      ],
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2ZM3.5 12C3.5 7.30558 7.30558 3.5 12 3.5C16.6944 3.5 20.5 7.30558 20.5 12C20.5 16.6944 16.6944 20.5 12 20.5C7.30558 20.5 3.5 16.6944 3.5 12ZM12 7.25C12.4142 7.25 12.75 7.58579 12.75 8V11.25H16C16.4142 11.25 16.75 11.5858 16.75 12C16.75 12.4142 16.4142 12.75 16 12.75H12.75V16C12.75 16.4142 12.4142 16.75 12 16.75C11.5858 16.75 11.25 16.4142 11.25 16V12.75H8C7.58579 12.75 7.25 12.4142 7.25 12C7.25 11.5858 7.58579 11.25 8 11.25H11.25V8C11.25 7.58579 11.5858 7.25 12 7.25Z" fill="currentColor"></path></svg>`,
      name: "Opérations",
      subItems: [
        { name: "Missions", path: "/missions" },
        { name: "Dotations Carburant", path: "/dotations-carburant" },
      ],
    },
